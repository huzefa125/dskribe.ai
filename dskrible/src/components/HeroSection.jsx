      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center lg:ml-20 lg:mr-20 lg:mt-25">
        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <button className="w-full sm:w-auto font-medium px-8 py-2 rounded-full border border-gray-300 hover:border-gray-400 transition-colors duration-200">
              Coming Soon
            </button>
          </div>
