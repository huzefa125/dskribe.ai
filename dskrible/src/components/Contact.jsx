...
export default function Contact() {
  ...
  const onSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_gn16okm", // your EmailJS service ID
        "template_vwy2gbh", // your EmailJS template ID
        formRef.current,
        "_UXA-uAphrsdVYwuY" // your public key
      )
      .then(
        () => {
          alert("Message sent to all co-founders!");
          setLoading(false);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions, feedback, or want to join our clinical network?
            Reach out below.
          </p>
        </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-blue-800">
                  Joining our waitlist? Select &apos;Join Waitlist&apos; below
                  and tell us about your practice. We&apos;ll notify you when
                  early access opens!
                </p>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-1 mb-5">
                ...
                <a
                  className="block text-blue-600 hover:underline break-all"
                  href="mailto:second@example.com"
                >
                  second@example.com
                </a>
                <a
                  className="block text-blue-600 hover:underline break-all"
                  href="mailto:third@example.com"
                >
                  third@example.com
                </a>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  We&apos;re currently recruiting clinicians, product testers,
                  and EHR partners. If you&apos;re interested, mention it in
                  your message or reach out directly!
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 text-center">
                ...
                <p className="text-gray-700 font-medium">
                  Remote-first – Based in California
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-center text-white shadow-lg">
            <h3 className="text-2xl font-semibold mb-4">
              Want to see dSkribe in action? Try it free.
            </h3>
            <button
              disabled
